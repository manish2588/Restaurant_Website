function AboutPage() {
  return (
    <main className="lg:flex lg:space-x-2 w-full mt-0" id="about">
      <section id="description" className=" basis-1/2 px-4 lg:my-auto">
        <div className="w-full lg:w-2/3 lg:ml-36 ">
          ...
          <p className="font-light text-base ">
            ...
            showcase the rich and diverse heritage of Nepal. Diners can enjoy a
            variety of dishes, made with fresh and locally sourced ingredients,
            while taking in the vibrant atmosphere of the restaurant. With its
            authentic Nepali decor and warm hospitality, Nepali Bhanchha is the
            perfect place to experience the flavors and culture of Nepal.
            <br />
            <br />
      ...
      >
        <div className=" lg:w-3/5 lg:h-4/5 lg:my-auto overflow-hidden">
          <img
            src="/image/BG.jpg"
            className="h-full p-4 lg:p-0 hover:scale-110 duration-1000 ease-in-out "
          />
        </div>
      </section>
    </main>
